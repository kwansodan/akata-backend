"""Alembic environment - run migrations with sync engine for PostgreSQL."""
import asyncio
...
# Use sync URL for Alembic (replace asyncpg with psycopg2 for running migrations)
...
async def run_async_run_migrations() -> None:
